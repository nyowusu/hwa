var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="images/handwash.gif" alt="how to wash your hands" class="svelte-1wsp3u5">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-6sgnzt");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-6sgnzt");
    	...
    	function startTimer() {
    		function countDown() {
    			...
    			if (secondLeft == 0) {
    				...
    				dispatch("finished", { text: "Timer Completed" });
    			}
    		}
    ...
    function create_fragment$3(ctx) {
    	...
    	timer.$on("finished", /*timerEnds*/ ctx[1]);
